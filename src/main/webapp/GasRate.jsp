        ...
        <main class="col-sm-10 overflow-auto h-100">
            <div class="bg-light border rounded-3 p-3">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr class="">
                        <th scope="col">Id</th>
                        <th scope="col">Gas rate per unit</th>
                        <th scope="col">Action</th>
                    </tr>
                    </thead>
                    <tbody>
                    <% List<GasUnitRate> gasRateList = (List<GasUnitRate>) request.getAttribute("gasRateList"); %>
                    <% for (GasUnitRate gasRate : gasRateList) { %>
                    <tr>
                        <th scope="row"><%= gasRate.getId() %></th>
                        <td><%= gasRate.getRate() %></td>
                        <td>
                            <a href="EditGasRate?id=<%= gasRate.getId() %>">
