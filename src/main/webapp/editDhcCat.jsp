    ...
    <main class="col-sm-10 overflow-auto h-100">
      <div class="bg-light border rounded-3 p-3">
        <div class="d-flex justify-content-between align-items-center">
          <h3>Edit Daily Help Category</h3>
        </div>
        <% DailyHelpCategory dhc = (DailyHelpCategory) request.getAttribute("dhc"); %>
        <div class="container">
          <div class="col-6" id="editFlats">
            <form class="needs-validation" novalidate action="updateDhc" method="post">
              <div class="mb-3">
                <label for="id" class="form-label">DHC Id</label>
                <input type="text" class="form-control" id="id" value="<%= dhc.getId()%>"  name="id" minlength="3"  readonly>
                <div class="invalid-feedback">Please enter a valid No.</div>
              </div>
              <div class="mb-3">
                <label for="cname" class="form-label">Category Name</label>
                <input type="text" class="form-control" id="cname" value="<%= dhc.getName()%>"  name="cname" minlength="3"  required>
