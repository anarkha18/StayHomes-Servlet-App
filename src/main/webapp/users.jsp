...
<%@ page import="com.stayhome.modal.userTypes" %>
            ...
            <div class="bg-light border rounded-3 p-3">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="editUser?id=<%= user.getId() %>"> <button type="button" class="btn btn-outline-primary me-2">Edit</button></a>
                            <a href="deleteUser?id=<%= user.getId() %>"> <button type="button" class="btn btn-primary">Delete</button></a>
                        </td>
                    </tr>
                    <% } %>
                    </tbody>
...
<script>
    (function () {
        ...
        var addUserForm = document.querySelector('#adduser .needs-validation');
